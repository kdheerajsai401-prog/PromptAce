...
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// PROMPTFORGE V10 — THE COMPLETE EDITION
// Everything from v9 PLUS:
// ✦ FPV Cinematic — Kling 2.6 (new video subtype)
// ✦ Background Text Control System
// ✦ Variation Dimension Lock (Bold = scene, not face)
// ✦ Unknown Technique Handler
// ✦ Seedream 3.0 + Recraft routing
// ✦ Scene Text Risk Detection
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

const SYSTEM = `You are PromptForge v10 — the world's most advanced Universal Prompt Intelligence Engine.
...
export default function PromptForge() {
  ...
  useEffect(() => {
    ...
    link.rel = "stylesheet";
    link.href = "https://fonts.googleapis.com/css2?family=DM+Sans:wght@300;400;500;600;700;800;900&family=JetBrains+Mono:wght@400;500&display=swap";
  ...
  const forge = async () => {
    ...
    let msg = input.trim();
    if (dna.niche || dna.tone || dna.platform) {
      msg += "\n\nBrand DNA:";
      if (dna.niche) msg += `\nNiche: ${dna.niche}`;
      if (dna.tone) msg += `\nTone: ${dna.tone}`;
  ...
  return (
    <div style={{ background: C.bg, minHeight: "100vh", fontFamily: C.sans, color: C.text }}>
      ...
      {/* MAIN GRID */}
      <div style={{ display: "grid", gridTemplateColumns: "350px 1fr", minHeight: "calc(100vh - 52px)" }}>
        ...
        <div style={{
          ...
          <div style={{ borderTop: `1px solid ${C.border}`, paddingTop: 10 }}>
            ...
            {showDNA && (
              <div style={{ marginTop: 8, display: "flex", flexDirection: "column", gap: 6 }}>
                {[["niche", "Niche / industry..."], ["tone", "Brand tone..."], ["platform", "Primary platform..."]].map(([k, ph]) => (
                  <input key={k} value={dna[k]} onChange={e => setDna(p => ({ ...p, [k]: e.target.value }))}
          ...
          <button onClick={forge} disabled={!input.trim() || loading} style={{
      ...
      <style>{`
        ...
        * { box-sizing: border-box; }
        textarea::placeholder { color: #161C2C; }
        input::placeholder { color: #161C2C; }
        textarea:focus { border-color: #1C2540 !important; }
        input:focus { border-color: #1C2540 !important; outline: none; }
        ::-webkit-scrollbar { width: 3px; }
        ::-webkit-scrollbar-thumb { background: #12172A; border-radius: 3px; }
      `}</style>
    </div>
  );
}
